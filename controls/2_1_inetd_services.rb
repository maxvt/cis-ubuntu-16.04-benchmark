...
control 'cis-ubuntu-16.04-2.1.1' do
  impact  1.0
...
control 'cis-ubuntu-16.04-2.1.2' do
  impact  1.0
...
control 'cis-ubuntu-16.04-2.1.3' do
  impact  1.0
...
control 'cis-ubuntu-16.04-2.1.4' do
  impact  1.0
...
control 'cis-ubuntu-16.04-2.1.5' do
  impact  1.0
...
control 'cis-ubuntu-16.04-2.1.6' do
  impact  1.0
...
control 'cis-ubuntu-16.04-2.1.7' do
  impact  1.0
...
control 'cis-ubuntu-16.04-2.1.8' do
  impact  1.0
...
control 'cis-ubuntu-16.04-2.1.9' do
  impact  1.0
...
control 'cis-ubuntu-16.04-2.1.10' do
  impact  1.0
  ...
  tag cis: 'ubuntu-16.04:2.1.10'

  only_if do
    package('xinetd').installed?
  end

  describe command('systemctl is-enabled xinetd') do
    its('stdout') { should eq 'disabled' }
  end
end

control 'cis-ubuntu-16.04-2.1.11' do
  impact  1.0
  title   '2.1.11 Ensure openbsd-inetd is not installed (Scored)'
  desc    'The inetd daemon listens for well known services and dispatches the appropriate daemon to properly respond to service requests.'

  tag cis: 'ubuntu-16.04:2.1.11'
