...
control 'cis-ubuntu-16.04-5.1.1' do
  impact  1.0
...
control 'cis-ubuntu-16.04-5.1.2' do
  impact  1.0
...
control 'cis-ubuntu-16.04-5.1.3' do
  impact  1.0
...
control 'cis-ubuntu-16.04-5.1.7' do
  impact  1.0
...
control 'cis-ubuntu-16.04-5.1.8' do
  impact  1.0
  ...
  tag cis: 'ubuntu-16.04:5.1.8'

  ['cron.deny', 'at.deny'].each do |f|
