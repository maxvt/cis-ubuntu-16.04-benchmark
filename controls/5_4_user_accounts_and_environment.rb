...
control 'cis-ubuntu-16.04-5.4.1.1' do
  impact  1.0
...
control 'cis-ubuntu-16.04-5.4.1.2' do
  impact  1.0
...
control 'cis-ubuntu-16.04-5.4.1.3' do
  impact  1.0
...
control 'cis-ubuntu-16.04-5.4.1.4' do
  impact  1.0
...
#control 'cis-ubuntu-16.04-5.4.1.5' do
#  impact  1.0
#  title   '5.4.1.5 Ensure all users last password change date is in the past (Scored)'
#end

control 'cis-ubuntu-16.04-5.4.2' do
  impact  1.0
...
control 'cis-ubuntu-16.04-5.4.3' do
  impact  1.0
...
control 'cis-ubuntu-16.04-5.4.5' do
  impact  1.0
  title   '5.4.5 Ensure default user shell timeout is 900 seconds or less (Scored)'
  desc    'The default TMOUT determines the shell timeout for users. The TMOUT value is measured in seconds.'

  tag cis: 'ubuntu-16.04:5.4.5'
  ...
  %w{
    ...
    describe file(f) do
      its(:content) { should match /^TMOUT=[0-9]{1,3}$/ } # technically up to 999 seconds
    end
  end
end
