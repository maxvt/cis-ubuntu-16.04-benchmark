...
control 'cis-ubuntu-16.04-1.2.1' do
  impact  0.0
  ...
  tag cis: 'ubuntu-16.04:1.2.1'

  describe command('apt-cache policy') do
    its('stdout') { should match /xenial\/(main|universe|multiverse|restricted)/ }
  end
end

control 'cis-ubuntu-16.04-1.2.2' do
  impact  0.0
