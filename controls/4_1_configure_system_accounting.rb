...
control 'cis-ubuntu-16.04-4.1.1.1' do
  impact  1.0
...
control 'cis-ubuntu-16.04-4.1.1.2' do
  impact  1.0
...
control 'cis-ubuntu-16.04-4.1.1.3' do
  impact  1.0
...
control 'cis-ubuntu-16.04-4.1.3' do
  impact  1.0
...
control 'cis-ubuntu-16.04-4.1.4' do
  impact  1.0
  ...
  #       PR closed due to lack of response by original author of this code
  #
...
control 'cis-ubuntu-16.04-4.1.5' do
  impact  1.0
  ...
  tag cis: 'ubuntu-16.04:4.1.5'

  # Why not use "auditd" resource? See note under cis-ubuntu-16.04-4.1.4
  describe file('/etc/audit/audit.rules') do
...
control 'cis-ubuntu-16.04-4.1.6' do
  impact  1.0
...
control 'cis-ubuntu-16.04-4.1.7' do
  impact  1.0
...
control 'cis-ubuntu-16.04-4.1.8' do
  impact  1.0
...
control 'cis-ubuntu-16.04-4.1.9' do
  impact  1.0
...
control 'cis-ubuntu-16.04-4.1.10' do
  impact  1.0
...
control 'cis-ubuntu-16.04-4.1.11' do
  impact  1.0
...
control 'cis-ubuntu-16.04-4.1.12' do
  impact  1.0
...
control 'cis-ubuntu-16.04-4.1.13' do
  impact  1.0
...
control 'cis-ubuntu-16.04-4.1.14' do
  impact  1.0
...
control 'cis-ubuntu-16.04-4.1.15' do
  impact  1.0
...
control 'cis-ubuntu-16.04-4.1.16' do
  impact  1.0
...
control 'cis-ubuntu-16.04-4.1.17' do
  impact  1.0
...
control 'cis-ubuntu-16.04-4.1.18' do
  impact  1.0
