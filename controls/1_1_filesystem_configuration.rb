...
control 'cis-ubuntu-16.04-1.1.1.1' do
  impact  1.0
...
control 'cis-ubuntu-16.04-1.1.1.2' do
  impact  1.0
...
control 'cis-ubuntu-16.04-1.1.1.3' do
  impact  1.0
...
control 'cis-ubuntu-16.04-1.1.1.4' do
  impact  1.0
...
control 'cis-ubuntu-16.04-1.1.1.5' do
  impact  1.0
...
control 'cis-ubuntu-16.04-1.1.1.6' do
  impact  1.0
...
control 'cis-ubuntu-16.04-1.1.2' do
  impact  1.0
...
control 'cis-ubuntu-16.04-1.1.3' do
  impact  1.0
...
control 'cis-ubuntu-16.04-1.1.4' do
  impact  1.0
...
control 'cis-ubuntu-16.04-1.1.5' do
  impact  1.0
...
control 'cis-ubuntu-16.04-1.1.6' do
  impact  1.0
...
control 'cis-ubuntu-16.04-1.1.9' do
  impact  1.0
...
control 'cis-ubuntu-16.04-1.1.10' do
  impact  1.0
...
control 'cis-ubuntu-16.04-1.1.11' do
  impact  1.0
...
control 'cis-ubuntu-16.04-1.1.12' do
  impact  1.0
...
control 'cis-ubuntu-16.04-1.1.13' do
  impact  1.0
  title   '1.1.13 Ensure nodev option set on /home partition (Scored)'
  desc    'The nodev mount option specifies that the filesystem cannot contain special devices.'

  tag cis: 'ubuntu-16.04:1.1.13'
...
control 'cis-ubuntu-16.04-1.1.14' do
  impact  1.0
  title   '1.1.14 Ensure nodev option set on /dev/shm partition (Scored)'
  desc    'The nodev mount option specifies that the filesystem cannot contain special devices.'

  tag cis: 'ubuntu-16.04:1.1.14'
...
control 'cis-ubuntu-16.04-1.1.15' do
  impact  1.0
  title   '1.1.15 Ensure nosuid option set on /dev/shm partition (Scored)'
  desc    'The nosuid mount option specifies that the filesystem cannot contain setuid files.'

  tag cis: 'ubuntu-16.04:1.1.15'
...
control 'cis-ubuntu-16.04-1.1.16' do
  impact  1.0
  title   '1.1.16 Ensure noexec option set on /dev/shm partition (Scored)'
  desc    'The noexec mount option specifies that the filesystem cannot contain executable binaries.'

  tag cis: 'ubuntu-16.04:1.1.16'
...
control 'cis-ubuntu-16.04-1.1.21' do
  impact  0.0
  ...
  tag cis: 'ubuntu-16.04:1.1.21'

  only_if do
    command('systemctl is-enabled autofs').exit_status == 0
  end

  describe file('/etc/init/autofs.conf') do
    its('content') { should eq 'disabled' }
  end
end
